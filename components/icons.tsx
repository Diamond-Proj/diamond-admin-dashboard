...
export function FolderIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M3 7a2 2 0 0 1 2-2h6l2 2h7a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7z" />
    </svg>
  );
}
...
export function TaskIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <rect x="9" y="3" width="13" height="13" rx="2" ry="2" />
      <path d="M9 13H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h5" />
    </svg>
  );
}
...
export function DataTransferIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
