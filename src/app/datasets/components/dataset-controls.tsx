      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center">
        <div className="relative w-full md:w-auto">
          ...
          <input
            ...
            className="w-full rounded-xl border border-slate-300/75 bg-white/85 py-2.5 pl-10 pr-4 text-slate-900 transition-all placeholder:text-slate-500 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 focus:outline-none md:w-80 dark:border-slate-600 dark:bg-slate-900/55 dark:text-slate-100"
          />
        </div>
